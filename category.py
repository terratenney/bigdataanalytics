...
# category column and then displays the 3 most frequent categories of crimes.
...
# contains category column and stores the type of category.
def mapper(record):
...
# reducer()
#
# This function counts the total number instances of a particular crime category
